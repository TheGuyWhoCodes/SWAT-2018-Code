...
public class RightSideScaleToBlockPart1 implements PathContainer {
    ...
    public Path buildPath() {
        ...
        sWaypoints.add(new Waypoint(281,75,5,60));
        sWaypoints.add(new Waypoint(240,30,20,60));
//        sWaypoints.add(new Waypoint(220,100,0,30));
    ...
    public RigidTransform2d getStartPose() {
        return new RigidTransform2d(new Translation2d(281, 75), Rotation2d.fromDegrees(0.0)); 
    }
