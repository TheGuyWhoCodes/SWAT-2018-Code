...
public class LeftSideScalePart4 implements PathContainer{
    ...
    public RigidTransform2d getStartPose() {
        if(Robot.isBlue){
            ...
            /// ---- RED ---- ///
            return new RigidTransform2d(new Translation2d(225, 186.5), Rotation2d.fromDegrees(RobotState.getInstance().getLatestFieldToVehicle().getValue().getRotation().getDegrees()));
        }
    }
