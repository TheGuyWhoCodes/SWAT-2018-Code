...
public class PathAdapter2018 {
	
    static final RobotProfile2018 kRobotProfile = new PracticeBot2018();
    static final FieldProfile2018 kFieldProfile = new PracticeField();
