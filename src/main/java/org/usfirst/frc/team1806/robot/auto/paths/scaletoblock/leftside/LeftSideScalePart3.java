...
public class LeftSideScalePart3 implements PathContainer {
    ...
    public RigidTransform2d getStartPose() {
        if(Robot.isBlue){
            ...
            /// ---- RED ---- ///
            return new RigidTransform2d(new Translation2d(260, 230), Rotation2d.fromDegrees(RobotState.getInstance().getLatestFieldToVehicle().getValue().getRotation().getDegrees()));
        }
    }
