...
public class LeftSideScalePart2 implements PathContainer {
    ...
    public RigidTransform2d getStartPose() {
        if(Robot.isBlue){
            ...
            /// ---- RED ---- ///
            return new RigidTransform2d(new Translation2d(226, 204), Rotation2d.fromDegrees(RobotState.getInstance().getLatestFieldToVehicle().getValue().getRotation().getDegrees()));
        }
