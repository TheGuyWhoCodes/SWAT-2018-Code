...
public class SwitchToCubePart4 implements PathContainer {

    @Override
    public Path buildPath() {
        ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
        sWaypoints.add(new Waypoint(70,215,0,0));
        sWaypoints.add(new Waypoint(116,215,0,100));
    ...
    // WAYPOINT_DATA: [{"position":{"x":70,"y":215},"speed":0,"radius":0,"comment":""},{"position":{"x":116,"y":215},"speed":100,"radius":0,"comment":""}]
    // IS_REVERSED: false
    // FILE_NAME: SwitchToCubePart4
}