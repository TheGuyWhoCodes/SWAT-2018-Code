...
public class LeftSideScalePart1 implements PathContainer {
    ...
    public Path buildPath() {
        return PathAdapter.leftSidePart1();
    }
    
    @Override
    public RigidTransform2d getStartPose() {
        return new RigidTransform2d(new Translation2d(260, 240), Rotation2d.fromDegrees(RobotState.getInstance().getLatestFieldToVehicle().getValue().getRotation().getDegrees()));
    }
